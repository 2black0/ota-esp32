...
class OTAUpdater:
    ...
    def fetch_latest_code(self)->bool:
        ...
        if response.status_code == 200:
            ...
            self.latest_code = response.content  # use response.content for binary data
            return True
    ...
    def update_no_reset(self):
        ...
        with open('latest_code.mpy', 'wb') as f:  # write in binary mode
    ...
    def update_and_reset(self):
        ...
        os.rename('latest_code.mpy', self.filename)  
